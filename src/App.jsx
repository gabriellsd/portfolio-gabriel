...
import {
  ...
  Mail, Linkedin, Github, ExternalLink, Network, Instagram, Camera, HeadphonesIcon,
} from 'lucide-react';
...
const gabriel = {
  ...
  whatsapp: 'https://wa.me/5541995671711',
  whatsappDisplay: '(41) 99567-1711',
...
const specialties = [
  ...
  },
  {
    ...
    desc: 'Atendimento técnico, resolução de problemas de hardware/software e treinamento de usuários finais.',
  },
];
...
export default function App() {
  ...
  return (
    <div className="bg-slate-100 text-slate-900">
      ...
      <a
        href={gabriel.whatsapp}
        target="_blank"
        rel="noreferrer"
        aria-label="Fale comigo no WhatsApp"
        className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-4 py-3 rounded-full shadow-lg hover:shadow-green-500/40 transition-all duration-300 group"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 shrink-0">
          ...
          <path d="M12 0C5.373 0 0 5.373 0 12c0 2.134.558 4.133 1.532 5.869L.054 23.446a.75.75 0 00.916.916l5.577-1.478A11.95 11.95 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.707 9.707 0 01-4.953-1.356l-.355-.212-3.686.976.976-3.569-.233-.368A9.718 9.718 0 012.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z"/>
        </svg>
        ...
        <div ref={contactRef} className="reveal max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-center space-x-3 p-6 bg-green-700 hover:bg-green-600 rounded-2xl transition"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 shrink-0 text-white">
                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/>
                <path d="M12 0C5.373 0 0 5.373 0 12c0 2.134.558 4.133 1.532 5.869L.054 23.446a.75.75 0 00.916.916l5.577-1.478A11.95 11.95 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.707 9.707 0 01-4.953-1.356l-.355-.212-3.686.976.976-3.569-.233-.368A9.718 9.718 0 012.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z"/>
              </svg>
              <span className="font-medium text-sm text-white">{gabriel.whatsappDisplay}</span>
            </a>
            <a
